...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Laravel\Sistema_Order_Rae\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Laravel\\Sistema_Order_Rae\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'productos.index','productos.create','productos.store',
'productos.show','productos.edit','productos.update','productos.destroy','categorias.index',
'categorias.create','categorias.store','categorias.show','categorias.edit','categorias.update',
'categorias.destroy','dashboard','produccion.index','produccion.create','produccion.store',
'produccion.show','produccion.edit','produccion.update','produccion.destroy','usuarios.index',
'usuarios.create','usuarios.store','usuarios.show','usuarios.edit','usuarios.update',
'usuarios.destroy','roles.index','roles.create','roles.store','roles.show',
'roles.edit','roles.update','roles.destroy','roles.permisos','roles.permisos.update',
'inventario.index','inventario.create','inventario.store','inventario.show','inventario.edit',
'inventario.update','inventario.destroy','proveedores.index','proveedores.create','proveedores.store',
'proveedores.show','proveedores.edit','proveedores.update','proveedores.destroy','bodegas.index',
'bodegas.create','bodegas.store','bodegas.show','bodegas.edit','bodegas.update',
'bodegas.destroy','ventas.index','ventas.create','ventas.store','ventas.show',
'ventas.destroy','clientes.index','clientes.create','clientes.store','clientes.show',
'clientes.edit','clientes.update','clientes.destroy','metodos_pago.index','metodos_pago.create',
'metodos_pago.store','metodos_pago.show','metodos_pago.edit','metodos_pago.update','metodos_pago.destroy',
'pedidos.index','pedidos.create','pedidos.store','pedidos.show','pedidos.edit',
'pedidos.update','pedidos.destroy','compras.index','compras.create','compras.store',
'compras.show','compras.edit','compras.update','compras.destroy','permisos.index',
'permisos.create','permisos.store','permisos.show','permisos.edit','permisos.update',
'permisos.destroy','reportes.compras-por-cliente','reportes.compras-por-cliente.excel','reportes.compras-por-cliente.pdf','storage.local',);
        registerArgumentsSet('views', 
'bodegas.create','bodegas.edit','bodegas.index','bodegas.show','categorias.create',
'categorias.edit','categorias.index','categorias.show','clientes.create','clientes.edit',
'clientes.index','clientes.show','compras.create','compras.edit','compras.index',
'compras.show','dashboard','inventario.create','inventario.edit','inventario.index',
'inventario.show','layouts.app','metodos_pago.create','metodos_pago.edit','metodos_pago.index',
'metodos_pago.show','pedidos.create','pedidos.edit','pedidos.index','pedidos.show',
'permisos.create','permisos.edit','permisos.index','permisos.show','produccion.create',
'produccion.edit','produccion.index','produccion.show','productos.create','productos.edit',
'productos.index','productos.show','proveedores.create','proveedores.edit','proveedores.index',
'proveedores.show','reportes.pdf.compras-por-cliente','roles.create','roles.edit','roles.index',
'roles.permisos','roles.show','usuarios.create','usuarios.edit','usuarios.index',
'usuarios.show','ventas.create','ventas.index','ventas.show','welcome',
...
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Laravel.Sistema_Order_Rae.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
