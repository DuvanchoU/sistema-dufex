...
<div class="bg-[#F8F5F0] min-h-screen px-6 py-6">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
        <form method="GET" action="{{ route('proveedores.index') }}" class="flex flex-wrap items-end gap-3">
            ...
            <div class="flex gap-2 mt-1">
                ...
                <a href="{{ route('proveedores.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md font-medium transition">
                    Limpiar
                </a>
            </div>
                    ...
                    @foreach($proveedores as $p)
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700 max-w-xs">
                                <div class="truncate" title="{{ $p->direccion ?? '' }}">
                                    {{ $p->direccion ?? '—' }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('proveedores.destroy', $p) }}" method="POST" onsubmit="return confirm('¿Eliminar este proveedor?')">
                                        @csrf @method('DELETE')
