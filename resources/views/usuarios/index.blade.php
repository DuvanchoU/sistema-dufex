    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
        <form method="GET" action="{{ route('usuarios.index') }}" class="flex flex-wrap items-end gap-3">
            ...
            <div class="flex-1 min-w-45">
                ...
                <input type="text" name="correo_usuario" value="{{ request('correo_usuario') }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#CBB8A0] focus:ring-[#CBB8A0] sm:text-sm"
            ...
            <div class="flex-1 min-w-36">
                ...
                <select name="rol_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#CBB8A0] focus:ring-[#CBB8A0] sm:text-sm">
            ...
            <div class="flex-1 min-w-32">
                ...
                <select name="genero" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#CBB8A0] focus:ring-[#CBB8A0] sm:text-sm">
                    <option value="">Todos</option>
            ...
            <div class="flex gap-2 mt-1">
                ...
                <a href="{{ route('usuarios.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md font-medium transition">
                    Limpiar
                </a>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('usuarios.destroy', $u) }}" method="POST" onsubmit="return confirm('¿Dar de baja este usuario?')">
                                        @csrf @method('DELETE')
